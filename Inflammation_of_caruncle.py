# predict the inflammation of the caruncle and/or plica
...
def read_learn_test(iter):
    dir_path_1 = 'cropped/Inflammation_of_caruncle/'
    img_size_1 = (100,100)
    ...
    svm_linear_agg = svm.SVC(kernel='linear', probability = True, C=0.001, class_weight='balanced')
