# predict the Swelling of the eyelids
...
def read_learn_test(iter):
    ...
    dir_path_1 = 'cropped/Swelling_of_eyelids/'
    img_size_1 = (250,200)
    ...
    X_train_doc = np.empty((0,img_size_1[0]*img_size_1[1]*3),dtype=np.uint8) # input data (images) used to train per-doc model
    ...
    X_test_doc = np.empty((0,img_size_1[0]*img_size_1[1]*3),dtype=np.uint8) # input data (images) used to test per-doc model
    ...
    svm_linear_Dr1 = svm.SVC(kernel='linear', C=0.001, probability=True, class_weight='balanced')
    ...
    svm_linear_Dr2 = svm.SVC(kernel='linear', C=0.001, probability=True, class_weight='balanced')
    ...
    svm_linear_Dr3 = svm.SVC(kernel='linear', C=0.001, probability=True, class_weight='balanced')
